...
class DisappointmentPanda {
    ...
    public function __construct() {
        $this -> advice = array();
        $this-> advice[] = 'Pain, all all of its form, is out body\'s most effective means of spurring action. It helps show us what\'s good for us versus what\'s bad for us.';
